package ro.pastiera.typeq25.inputmethod
...
import ro.pastiera.typeq25.inputmethod.KeyboardEventTracker
import android.os.Handler
import android.os.Looper
import androidx.core.content.ContextCompat
import android.view.MotionEvent
import android.view.View
import ro.pastiera.typeq25.CurrencyManager
import ro.pastiera.typeq25.DeviceManager
import android.media.AudioManager
import ro.pastiera.typeq25.core.AutoCorrectionManager
import ro.pastiera.typeq25.core.InputContextState
import ro.pastiera.typeq25.core.ModifierStateController
import ro.pastiera.typeq25.core.NavModeController
import ro.pastiera.typeq25.core.SymLayoutController
import ro.pastiera.typeq25.core.TextInputController
import ro.pastiera.typeq25.data.layout.LayoutMappingRepository
import ro.pastiera.typeq25.data.layout.LayoutFileStore
import ro.pastiera.typeq25.data.layout.LayoutMapping
import ro.pastiera.typeq25.data.mappings.KeyMappingLoader
import ro.pastiera.typeq25.data.variation.VariationRepository
import ro.pastiera.typeq25.inputmethod.SpeechRecognitionActivity
...
class PhysicalKeyboardInputMethodService : InputMethodService(), LifecycleOwner, SavedStateRegistryOwner, ViewModelStoreOwner {
    ...
    // Symbol picker popup
    private var symbolPickerPopup: ro.pastiera.typeq25.inputmethod.ui.SymbolPickerPopup? = null
    
    // Clipboard history
    private lateinit var clipboardHistoryManager: ro.pastiera.typeq25.clipboard.ClipboardHistoryManager
    private var clipboardHistoryPopup: ro.pastiera.typeq25.inputmethod.ui.ClipboardHistoryPopup? = null
    
    // Emoji shortcode support
    private lateinit var emojiShortcodeManager: ro.pastiera.typeq25.emoji.EmojiShortcodeManager
    private var emojiShortcodePopup: ro.pastiera.typeq25.inputmethod.ui.EmojiShortcodePopup? = null
    ...
    private lateinit var modifierOverlay: ro.pastiera.typeq25.inputmethod.ui.ModifierOverlay
    ...
    override fun onCreate() {
        ...
        modifierOverlay = ro.pastiera.typeq25.inputmethod.ui.ModifierOverlay(this)
        ...
        clipboardHistoryManager = ro.pastiera.typeq25.clipboard.ClipboardHistoryManager(this)
        clipboardHistoryManager.startMonitoring()
        
        // Initialize emoji shortcode manager
        emojiShortcodeManager = ro.pastiera.typeq25.emoji.EmojiShortcodeManager(this)
        ...
        ro.pastiera.typeq25.SettingsManager.initializeNavModeMappingsFile(this)
        ctrlKeyMap.putAll(KeyMappingLoader.loadCtrlKeyMappings(assets, this))
        ...
        ro.pastiera.typeq25.data.DefaultSpecialChars.load(this, assets)
    ...
    private fun showSymbolPickerPopup() {
        ...
        if (symbolPickerPopup == null) {
            ...
            symbolPickerPopup = ro.pastiera.typeq25.inputmethod.ui.SymbolPickerPopup(
                context = this,
    ...
    private fun showClipboardHistoryPopup() {
        ...
        clipboardHistoryPopup = ro.pastiera.typeq25.inputmethod.ui.ClipboardHistoryPopup(
            context = this,
    ...
    private fun updateStatusBarText() {
        ...
        val finalVariations = if (variationSnapshot.variations.isEmpty() && suggestions.isEmpty()) {
            ...
            ro.pastiera.typeq25.data.DefaultSpecialChars.getDefaultChars(8)
        } else {
    ...
    private fun checkAndShowEmojiShortcode() {
        ...
        val emojiEnabled = ro.pastiera.typeq25.SettingsManager.getEmojiShortcodeEnabled(this)
        val symbolEnabled = ro.pastiera.typeq25.SettingsManager.getSymbolShortcodeEnabled(this)
    ...
    private fun showEmojiShortcodeSuggestions(suggestions: List<Pair<String, String>>) {
        ...
        if (emojiShortcodePopup?.isShowing() == true) {
            ...
            // Create new popup
            emojiShortcodePopup = ro.pastiera.typeq25.inputmethod.ui.EmojiShortcodePopup(
                context = this,
            ...
            if (inCall) {
                ...
                try {
                    ...
                    val messageResId = if (targetState) 
                        ro.pastiera.typeq25.R.string.speaker_toggle_on 
                    else 
                        ro.pastiera.typeq25.R.string.speaker_toggle_off
                    Handler(Looper.getMainLooper()).post {
                ...
                Handler(Looper.getMainLooper()).post {
                    android.widget.Toast.makeText(
                        this, 
                        ro.pastiera.typeq25.R.string.speaker_toggle_not_in_call, 
                        android.widget.Toast.LENGTH_SHORT
                    ).show()
                }
            }
