...
import ro.pastiera.typeq25.MainActivity
import ro.pastiera.typeq25.SymCustomizationActivity
import ro.pastiera.typeq25.SettingsManager
import kotlin.math.max
import android.view.MotionEvent
import android.view.KeyEvent
import kotlin.math.abs
import ro.pastiera.typeq25.inputmethod.ui.VariationBarView
...
class StatusBarController(
    ...
    fun update(snapshot: StatusSnapshot, emojiMapText: String = "", inputConnection: android.view.inputmethod.InputConnection? = null, symMappings: Map<Int, String>? = null) {
        ...
        val deviceType = ro.pastiera.typeq25.DeviceManager.getDevice(context)
