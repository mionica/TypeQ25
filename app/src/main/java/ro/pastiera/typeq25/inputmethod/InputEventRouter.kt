...
import ro.pastiera.typeq25.inputmethod.AltSymManager
import ro.pastiera.typeq25.core.SymLayoutController
import ro.pastiera.typeq25.core.SymLayoutController.SymKeyResult
...
import ro.pastiera.typeq25.data.layout.isRealMultiTap
        ...
        if (isQ25Device && keyCode == 7) {
            ...
            when (behavior) {
                ...
                "alt_zero" -> {
                    ...
                    if (!isAltActive) {
                        (context as? ro.pastiera.typeq25.inputmethod.PhysicalKeyboardInputMethodService)?.let { service ->
    ...
    private fun recordWordBeforeSpace(ic: android.view.inputmethod.InputConnection) {
        try {
            ...
            if (lastWord.isNotEmpty() && lastWord.length >= 2) {
                (context as? ro.pastiera.typeq25.inputmethod.PhysicalKeyboardInputMethodService)?.let { svc ->
                    try {
