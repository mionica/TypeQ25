...
class SpeechRecognitionActivity : Activity() {
    companion object {
        ...
        const val ACTION_SPEECH_RESULT = "ro.pastiera.typeq25.SPEECH_RESULT"
                ...
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (spokenText.isNotEmpty()) {
                        ...
                        val broadcastIntent = Intent(ACTION_SPEECH_RESULT).apply {
                            ...
                            setPackage("ro.pastiera.typeq25") // Send to our own app package
                        }
                        sendBroadcast(broadcastIntent)
                        Log.d(TAG, "Broadcast sent to ro.pastiera.typeq25: $ACTION_SPEECH_RESULT with text: $spokenText")
                    } else {
