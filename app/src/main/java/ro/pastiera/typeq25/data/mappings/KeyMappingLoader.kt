package ro.pastiera.typeq25.data.mappings
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                if (keyCode != null && context != null) {
                    val currentLayout = ro.pastiera.typeq25.SettingsManager.getKeyboardLayout(context)
                    if (currentLayout.startsWith("arabic", ignoreCase = true)) {
                        if (ro.pastiera.typeq25.SettingsManager.getUseArabicNumerals(context)) {
                            character = convertToArabicNumerals(character)
                        }
                        if (ro.pastiera.typeq25.SettingsManager.getUseArabicPunctuation(context)) {
